...
// Text automatic change color
//    scriviColor("YOUR TEXT HERE");

// Text single color: set the color of text (see Definitions.h)
    for (int i=0; i<95; i++) {
      scrivi("PIX MATRIX", MAGENTA);
    }
    
// Single shape
//    sprite(tetrisc1,BLUE,wait);
...
void multicolor(const uint8_t* x, unsigned long y){
...
void multi() {
    multicolor(center1,RED);
    multicolor(center2,YELLOW);
    multicolor(center3,GREEN);
    multicolor(center4,VIOLET);
    matrix.show();
    delay(200);
    matrix.fillScreen(0);
    multicolor(center1,VIOLET);
    multicolor(center2,RED);
    multicolor(center3,YELLOW);
    multicolor(center4,GREEN);
    matrix.show();
    delay(200);
    matrix.fillScreen(0);
    multicolor(center1,GREEN);
    multicolor(center2,VIOLET);
    multicolor(center3,RED);
    multicolor(center4,YELLOW);
    matrix.show();
    delay(200);
    matrix.fillScreen(0);
    multicolor(center1,YELLOW);
    multicolor(center2,GREEN);
    multicolor(center3,VIOLET);
    multicolor(center4,RED);
    matrix.show();
    delay(200);
    matrix.fillScreen(0);
}
 ...
 void tetris() {
   sprite(tetrisa1,GREEN,wait);
   sprite(tetrisa2,GREEN,wait);
   sprite(tetrisa3,GREEN,wait);
   sprite(tetrisb1,VIOLET,wait);
   sprite(tetrisb2,VIOLET,wait);
   sprite(tetrisb3,VIOLET,wait);
   sprite(tetrisc1,BLUE,wait);
   sprite(tetrisc2,BLUE,wait);
   sprite(tetrisc3,BLUE,wait);
   sprite(tetrisc4,BLUE,wait);
   sprite(tetrisc5,BLUE,wait);
   sprite(tetrisc6,BLUE,wait);
   sprite(tetrisc7,BLUE,wait);
 }
 
 void pong() {
   sprite(pong1,GREEN,wait);
   sprite(pong2,GREEN,wait);
   sprite(pong3,GREEN,wait);
   sprite(pong4,GREEN,wait);
   sprite(pong5,GREEN,wait);
   sprite(pong6,GREEN,wait);
   sprite(pong7,GREEN,wait);
   sprite(pong8,GREEN,wait);
   sprite(pong9,GREEN,wait);
   sprite(pong10,GREEN,wait);
   sprite(pong11,GREEN,wait);
   sprite(pong12,GREEN,wait);
 }   
